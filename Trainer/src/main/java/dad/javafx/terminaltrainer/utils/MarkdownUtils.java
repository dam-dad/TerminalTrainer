...
public class MarkdownUtils {
	...
	private static final String TEMPLATE_BEGIN = 
			"<html>" + "\n" + 
				"<head>" + "\n" + 
					"<script>" + ResourceUtils.getResourceAsString("/markdown/js/markdown.js") + "</script>" + "\n" + 
					"<style>" + ResourceUtils.getResourceAsString("/markdown/css/markdown.css") + "</style>" + "\n" + 
				"</head>" + "\n" + 
				"<body>";
	...
	public static String renderToUrl(String markdown) {
		try {
			File temp = File.createTempFile("terminal-trainer-", ".html");
